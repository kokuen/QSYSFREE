...
These fields have been transformed into "ind" types to go accordingly with it (no retro-compatibility problem as both are exactly a one byte long data).
...
## Include guard
Compiler instructions have been added as "include guards" at the beginning of every source memeber to avoid any inclusion redundancy.